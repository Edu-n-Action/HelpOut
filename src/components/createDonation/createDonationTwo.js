...
function CreateDonationTwo({ SetData, Data, SetIndex }) {
  console.log(Data);
    ...
    <>
      <div className="w-full aspect-[379/50]">
        <div className="aspect-[379/127] w-full mb-[20px]">
          ...
          <InputImage
            value={Data.qrCode}
            SetValue={setValuePictureQR}
            className="aspect-[379/200] w-full rounded-[3%/10%]"
          />
        </div>
...
export default CreateDonationTwo;
