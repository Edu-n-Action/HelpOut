    ...
    <div className="w-[90%] mt-[5%] h-fit flex-col gap-10">
      {materials.map((item, index) => {
        return (
          ...
          >
            <div className="relative aspect-[390/73] w-[99%] px-[3%] shadow-md bg-back rounded-[3%/15%] flex flex-row justify-between items-center md:text-[1.4vw] text-[4.2vw]">
              <div className="overflow-ellipsis">{item}</div>
              <button className="absolute aspect-[1/1] min-w-[6%] right-[3%]">
